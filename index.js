...
app.get("/getposts/:pageId", async (req, res) => {
  ...
  await page.setCookie([
    ...
    {
      name: "fr",
      value: "0qGQTb8f1Pgq4ikUL..BkJ__S._V.AAA.0.0.BkJ__V.AWU1MY-eWaY",
      domain: ".facebook.com",
      path: "/",
      expires: 1688118994.532984,
      size: 57,
      httpOnly: true,
      secure: true,
      session: false,
    ...
    {
      name: "sb",
      value: "0v8nZNzplZ-_dHATGzH4WjIG",
      domain: ".facebook.com",
      path: "/",
      expires: 1714902993.1356,
      size: 26,
      httpOnly: true,
      secure: true,
      session: false,
    ...
    {
      name: "datr",
      value: "0v8nZL2zz-9WF_qdGujU-wo_",
      domain: ".facebook.com",
      path: "/",
      expires: 1714902993.135048,
      size: 28,
      httpOnly: true,
      secure: true,
      session: false,
